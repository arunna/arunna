	...
	function users_list($result){
		...
		while($d=$db->fetch_array($result)){
			$list.="<div class=\"list_item clearfix\" id=\"the_item_$i\">
                    ...
                    <div class=\"avatar\" ><a href=\"".user_url($d['luser_id'])."\"><img src=\"".get_avatar($d['luser_id'], 3)."\" /></a></div>
					<div class=\"title_username\" >
						<a href=\"".user_url($d['luser_id'])."\" style=\"display:block;text-decoration:none;\">".$d['lusername']."</a>
					</div>
